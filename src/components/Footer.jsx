    ...
    <footer className="bg-slate-100">
      <div className=" py-10 px-6">
        ...
        <div className=" max-w-[400px]">
          <img src={health} alt="" />
          <p className=" pt-3">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Neque, repudiandae maiores sint veniam suscipit quis aperiam. Alias natus magnam repellat.</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between pt-5  max-w-[1200px] m-auto border-t text-center md:text-start border-[#0A7DCF] sm:flex-row">
          ...
          <div className="">
           <ul className=" flex   flex-col md:flex-row gap-3">
            <li className=" border-r pr-3 text-[#0A7DCF] border-black"><a href="/">Privacy Policy</a></li>
